      ...
      <Form @submit="handleLogin()" class="h-auto lg:w-1/3 md:w-2/4 w-3/4 gradient-bg duration-200 rounded shadow-lg shadow-black p-10 long-text tracking-wide">
        ...
        <section>
          ...
          <span class="flex items-center relative">
            ...
            class="w-full bg-[#cbd2d7] focus:bg-[#e5e8eb] py-2 px-3 pr-12 rounded border border-black transition-all duration-300 outline-none focus:border-white text-black mb-2 mt-1" :rules="validatePassword" v-model="state.user.password"
            />
        ...
        <button type="submit" class="btn-form bg-[#081a28]">Admin Login</button>
